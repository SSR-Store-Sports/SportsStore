...
<body>
  <div class="container-privacity">
    ...
    <ul>
      ...
      <li>Enviar atualizações e rastreamento</li>
      <li>Oferecer suporte ao cliente</li>
      <li>Melhorar a experiência na loja</li>
      <li>Enviar promoções (com consentimento)</li>
    </ul>
    <br>

    <h2>3. Compartilhamento de Dados</h2>
    <br>
    <p>Não vendemos seus dados. Compartilhamos apenas com serviços essenciais como:</p>
    <br>
    <ul>
    ...
    <ul>
      ...
      <li>Cópia das informações tratadas</li>
    </ul>
    <br>
    <p>Contato para solicitações: <strong>contato@tatifitwear.com.br</strong></p>
    <br>
