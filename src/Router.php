...
require '/src/utils/Bramus/Router.php';

use Bramus\Router\Router;

$router = new Router();

include '/views/_components/header/index.php';
include '/views/_components/sidebar/index.php';
...
include '/views/_components/footer/index.php';
